	...
	switch(currentLocation){
		case "forest":
			...
			if (response==="go west"){
				...
				alert("you're going the wrong way!")
			}
		break;
		case "house":
			alert(houseMessage);
			...
			if(response==="go inside"){
				...
				prompt("are you sure you don't want to go in?");
			}
		break;
		case "clearing":
			...
			if(response==="go west"){
				...
				prompt("pick another direction goober");
			}
		break;
		case "pond":
			alert(pondMessage);
			...
			if (response==="go north"){
				...
				alert("sorry Dave, you're going to die brother");
				currentLocation=winDestination;
			}else{
				prompt("come on man! Pick another direction!");
			};
	}
	switch(currentLocation){}
}
